---
name: code-review
triggers: ["rà soát code", "xem code", "review code", "xem giúp code", "xem thay đổi", "kiểm tra thay đổi", "rà soát bản vá", "xem chênh lệch", "đánh giá mã", "kiểm tra code", "xem lại code"]
---
