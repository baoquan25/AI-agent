...
"""
ExecutionService — runs code via Jupyter kernel or direct sandbox.process.

Extracted from routers/run.py to keep the router thin.
"""
...
class ExecutionService:
    """Handles code execution logic with Jupyter fallback."""
    ...
    def run_code(self, sandbox, code: str, *, use_jupyter: bool = True, timeout: int = 30) -> dict[str, Any]:
        ...
        Args:
            ...
            use_jupyter: Whether to try Jupyter kernel first.
            timeout: Execution timeout in seconds.

        Returns:
            dict with output, exit_code, success, and outputs keys.
        """
        if use_jupyter:
